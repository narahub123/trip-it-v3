...
function Rewrite (props : any) {
    
        async function rewrite() {
            
                await axios.post(process.env.REACT_APP_BASE_URL+`/community/communityDetail/update/${props.postId}`
                ,{
                    postTitle : title,
                    postContent : content,
                    postPic : file,
                        ...
                        <div className="write-content2">
                            <div className="write-content-head">
                                <div className="write-header">
                                    <div className="write-back" onClick={()=>{props.setRewrite(0)}}>
                                    ...
                                    <div className="write-header-title">
                                        <p className="font">"글 수정"</p>
                                        <span className="write-header-title-sub">
                                            (필수)
                                        </span>
                                    </div>
                                    <div className="write-xx" onClick={()=>{props.setRewrite(0)}}>
                            ...
                            <div className="write-footer">
                                <button className={"write-button" + (inputTitleCount >= 5 && inputContentCount >= 20 ? "act" : "")} onClick={()=>{rewrite()}}>
