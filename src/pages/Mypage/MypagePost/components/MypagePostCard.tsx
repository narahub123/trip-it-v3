...
import calendar from "../../../Community/image/calendar.png";
import eye from "../../../Community/image/calendar.png";
import chat from "../../../Community/image/calendar.png";
...
const MypagePostCard = ({ posts, post, index }: MypagePostCardProps) => {
      ...
      >
        ...
        >
          <div className="post-col-head">
            <div className="post-col-head-profile">
              ...
              <div className="post-profile-name">
                ...
                <div className="post-profile-name-spec">
                  <p className="post-profile-name-spec-font">
            ...
            <div className="post-col-head-duration">
              ...
              <div className="post-duration-spec">
                <p className="post-duration-spec-day">
          ...
          <div className="post-col-img">
            ...
            <div
              className={"post-col-hide" + (post.exposureStatus ? "" : "no")}
            >
              <div className="post-col-hide-left">
                <p className="post-left-font">
                  {post.exposureStatus ? "현재 모집중" : "모집완료"}
                </p>
              </div>
