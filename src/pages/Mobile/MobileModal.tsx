...
const MobileModal = ({ message, setMessage, password }: MobileModalProps) => {
  ...
  return (
    <div className="mobile-modal" onClick={(e) => handleClose(e)}>
      <div className="mobile-modal-container" onClick={(e) => handleClose(e)}>
        <div className="mobile-modal-inner">
          <div className="mobile-modal-message">
            <p
              className={`mobile-modal-message-header ${
            ...
            <p
              className={`mobile-modal-message-main ${
                message.msgs.main ? "active" : undefined
              }`}
            >
              {message.msgs.main}
          ...
          <div className="mobile-modal-btns">
            <>
              <button
                className={`mobile-modal-btns cancel ${
              ...
              <button
                className="mobile-modal-btns confirm"
                onClick={
