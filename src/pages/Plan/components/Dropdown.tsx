...
// DropdownProps 인터페이스: 컴포넌트에 전달될 props의 타입을 정의합니다.
...
const Dropdown = ({ value, array, setFunc }: DropdownProps) => {
  ...
  return (
    <div className="dropdown" ref={dropdownRef}>
      ...
      <p className="dropdown-title" onClick={(e) => handleOpen(e)}>
        {value}
      </p>
      {open && (
        <ul className={`dropdown-container active`} ref={listRef}>
